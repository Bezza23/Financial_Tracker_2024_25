...
var _this = this;
// Constants
var API_URL = 'https://your-api.com/signup';
var REDIRECT_URL = '/user-dashboard.html';
// Select elements with type assertions for better type safety
...
// Main form handling
if (form && emailInput && passwordInput && confirmPasswordInput && errorMessage) {
    form.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
        var email, password, confirmPassword, isValid, response, data, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!password || !isValidPassword(password)) {
                        displayFieldError(passwordInput, 'Password must be at least 8 characters long and contain uppercase, lowercase, and numbers');
                        isValid = false;
                    }
